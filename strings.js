...
export const T = {
  ...
  st: {
    ...
    profileNote: 'Die Null ist der erste Tag der Periode, negative Werte sind die Tage davor. Bleibt die Kurve auch weit weg von der Null hoch, ist der Schmerz nicht nur menstruell. Die Balken zeigen, in wie vielen der erfassten Zyklen an diesem Tag Blähbauch angekreuzt war.',
